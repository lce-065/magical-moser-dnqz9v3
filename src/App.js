...
>
<style>{`@keyframes spin-sakura { 0% { transform: translate(-50%, -50%) rotate(0deg) scale(0.95); } 50% { transform: translate(-50%, -50%) rotate(180deg) scale(1.05); } 100% { transform: translate(-50%, -50%) rotate(360deg) scale(0.95); } } @keyframes pulse-glow { 0%, 100% { opacity: 0.6; transform: scale(0.9); } 50% { opacity: 1; transform: scale(1.1); } } .sakura-container { position: relative; width: 80px; height: 80px; display: flex; align-items: center; justify-content: center; } .japan-sun { width: 36px; height: 36px; background-color: #C1633D; border-radius: 50%; box-shadow: 0 0 15px rgba(193, 99, 61, 0.3); animation: pulse-glow 2s infinite ease-in-out; z-index: 1; } .sakura-petals { position: absolute; top: 50%; left: 50%; width: 80px; height: 80px; transform: translate(-50%, -50%); animation: spin-sakura 6s infinite linear; } .petal { position: absolute; width: 14px; height: 14px; background: #FBEAE1; border: 1px solid #E8B4B8; border-radius: 12px 0 12px 0; top: 50%; left: 50%; } .petal-1 { transform: translate(-50%, -50%) rotate(0deg) translate(30px); } .petal-2 { transform: translate(-50%, -50%) rotate(72deg) translate(30px); } .petal-3 { transform: translate(-50%, -50%) rotate(144deg) translate(30px); } .petal-4 { transform: translate(-50%, -50%) rotate(216deg) translate(30px); } .petal-5 { transform: translate(-50%, -50%) rotate(288deg) translate(30px); }`}</style>
...
>
<style>{`@import url('https://fonts.googleapis.com/css2?family=Noto+Serif+TC:wght@600;700&family=Noto+Sans+TC:wght@400;500;600;700&display=swap'); * { box-sizing: border-box; } .serif { font-family: 'Noto Serif TC', serif; } .scrollbar-thin::-webkit-scrollbar { height: 6px; width: 6px; } .scrollbar-thin::-webkit-scrollbar-thumb { background: #D9CFBB; border-radius: 4px; } button { cursor: pointer; font-family: inherit; } input, textarea, select { font-family: inherit; } .card-enter { animation: rise 0.25s ease both; } @keyframes rise { from { opacity: 0; transform: translateY(6px); } to { opacity: 1; transform: translateY(0); } } .app-container { display: flex; flex-direction: column; width: 100%; max-width: 1024px; margin: 0 auto; } .top-nav { display: flex; gap: 8px; overflow-x: auto; padding: 12px 16px 8px; border-bottom: 1px solid #ECE4D2; background: #FAF6EF; } .fw-spark { position: absolute; top: 0; left: 0; width: 5px; height: 5px; border-radius: 50%; background: var(--fw-color); box-shadow: 0 0 6px 1px var(--fw-color); opacity: 0; animation: fw-pop 1.6s ease-out infinite; } @keyframes fw-pop { 0% { transform: rotate(var(--fw-angle)) translateY(0); opacity: 1; } 70% { opacity: 1; } 100% { transform: rotate(var(--fw-angle)) translateY(-34px); opacity: 0; } }`}</style>
